  ...
  try {
    ...
    if (formTemplatesTableCheck.rows.length === 0) {
      ...
      const methodFields = JSON.stringify([
        ...
        {"name":"dietaryPreference","type":"radio","label":"Dietary Preference","labelEs":"Preferencia Alimenticia","options":[{"label":"No dietary restrictions","value":"none","labelEs":"Sin restricciones dietéticas"},{"label":"Vegetarian","value":"vegetarian","labelEs":"Vegetariano"},{"label":"Vegan","value":"vegan","labelEs":"Vegano"},{"label":"Other / Allergies","value":"other","labelEs":"Otro / Alergias"}],"required":true},
        {"name":"dietaryNotes","type":"text","label":"Please specify dietary needs","labelEs":"Por favor especifique sus necesidades dietéticas","required":false,"conditionalOn":{"field":"dietaryPreference","value":"other"},"placeholder":"Enter dietary needs or allergies...","placeholderEs":"Ingrese necesidades dietéticas o alergias..."},
